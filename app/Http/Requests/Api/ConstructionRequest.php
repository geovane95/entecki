...
class ConstructionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'responsible' => 'required|exists:responsibles,id',
    ...
    public function messages()
    {
        return [
            ...
            'company.required' => 'O nome da construtora é obrigatório',
            'company.min'=>'O nome da construtora deve ter no minimo 7 caracteres',
            'responsible.required' => 'Responsável não pode ficar em branco.',
            'responsible.exists' => 'Responsável tem que ser algum já cadastrado na base de dados.',
