...
class CreateDataTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement('ALTER TABLE data CHANGE TAXAADMP TAXAADMP decimal(12,2) signed');
        DB::statement('ALTER TABLE data CHANGE MANUTENCAOP MANUTENCAOP decimal(12,2) signed');
    }
