    ...
    <div class="container d-flex align-items-center justify-content-between">
        <div class="branding">
            <a href="https://entecki.com.br/" class="custom-logo-link" rel="home">
                <img width="285" height="54" src="../../../public/images/entecki.svg" class="custom-logo" alt="Entecki">
            </a>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4 offset-lg-4">
                <form class="login" action="{{ route('login') }}" method="post">
                    ...
                    <label>
                        Usuário
                        <input type="text" name="user" id="user" placeholder="Digite seu usuário aqui">
                    </label>
                    <label>
                        Senha
