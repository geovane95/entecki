        ...
        <div class="container d-flex align-items-center justify-content-between">
            <div class="branding">
                <a href="https://entecki.com.br/" class="custom-logo-link" rel="home">
                    <img width="285" height="54" src="https://entecki.com.br/wp-content/uploads/2019
             ...
             <div class="row">
                 <div class="col-lg-4 offset-lg-4">
                     <form class="login">
                        ...
                        <p>
                            Digite seu nome de usuário ou endereço de e-mail. Você receberá um link para criar uma nova senha via e-mail.
                        </p>
                        <label>
                            Usuário/E-mail
