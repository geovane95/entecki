        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ol>
                    ...
                    <li>
                        <strong>Escolher o Mês de Referência:</strong><br>
                        Todos os arquivos estão atrelados ao mês de referência, para que a evolução das obras possa ser acompanhada. Neste campo você seleciona um mês previamente cadastrado. Caso o mês que procura não esteja disponível basta cadastrá-lo no menu <a href="http://painel.entecki.com.br/home/competence">Mês de Referência</a>.
                    </li>
                    <li>
                        <strong>Escolher a Obra:</strong><br>
